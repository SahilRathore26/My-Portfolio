    ...
    <nav className="bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 shadow-md sticky top-0 z-50">
      ...
      {isOpen && (
        <div className="md:hidden bg-purple-700 px-6 py-4 space-y-3 text-white font-medium">
          ...
          <Link to="/skills" onClick={() => setIsOpen(false)} className="block hover:text-yellow-300">Skills</Link>
          <Link to="/projects" onClick={() => setIsOpen(false)} className="block hover:text-yellow-300">Projects</Link>
          <Link to="/experience" onClick={() => setIsOpen(false)} className="block hover:text-yellow-300">Experience</Link>
          <Link to="/achievements" onClick={() => setIsOpen(false)} className="block hover:text-yellow-300">Achievements</Link>
          <Link to="/education" onClick={() => setIsOpen(false)} className="block hover:text-yellow-300">Education</Link>
